...
*** SOF ./modules/32_power/IntCwPyPSAexport/equations.gms
...
q32_load(t,regi,enty2)$(tPy32(t) and regPy32(regi) and sameas(enty2,"seel"))..
  ...
  !! do not use in 2005 because this demand is not contained in 05_initialCap
  + sum(pe2rlf(enty3,rlf2), (pm_fuExtrOwnCons(regi, enty2, enty3) * vm_fuExtr(t,regi,enty3,rlf2))$(pm_fuExtrOwnCons(regi, enty2, enty3) gt 0))$(t.val > 2005) 
...
*' @stop
*** EOF ./modules/32_power/IntCwPyPSAexport/equations.gms
