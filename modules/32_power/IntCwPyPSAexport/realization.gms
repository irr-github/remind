...
*** SOF ./modules/32_power/IntCwPyPSAexport/realization.gms

*' @description  
*'
*'The `IntCwPyPSAexport` realization (Integrated Costs) assumes a single electricity market balance.
*'
...
*'
*' @authors Robert Pietzcker, Falko Ueckerdt, Renato Rodrigues, Adrian OD, Ivan Ramirez

*####################### R SECTION START (PHASES) ##############################
$Ifi "%phase%" == "sets" $include "./modules/32_power/IntCwPyPSAexport/sets.gms"
$Ifi "%phase%" == "declarations" $include "./modules/32_power/IntCwPyPSAexport/declarations.gms"
$Ifi "%phase%" == "datainput" $include "./modules/32_power/IntCwPyPSAexport/datainput.gms"
$Ifi "%phase%" == "equations" $include "./modules/32_power/IntCwPyPSAexport/equations.gms"
$Ifi "%phase%" == "preloop" $include "./modules/32_power/IntCwPyPSAexport/preloop.gms"
$Ifi "%phase%" == "bounds" $include "./modules/32_power/IntCwPyPSAexport/bounds.gms"
$Ifi "%phase%" == "presolve" $include "./modules/32_power/IntCwPyPSAexport/presolve.gms"
$Ifi "%phase%" == "postsolve" $include "./modules/32_power/IntCwPyPSAexport/postsolve.gms"
*######################## R SECTION END (PHASES) ###############################

*** EOF ./modules/32_power/IntCwPyPSAexport/realization.gms
